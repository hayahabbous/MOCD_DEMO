...
class disabledCardRequests {
    ...
    static func CreateRenewDisabledCardRequest_ByObject(ApplicantTypeId: String , NationalityId:String ,IdentificationNo: String ,UID: String ,FirstNameAR:String ,FatherNameAR:String ,GrandfatherNameAR:String ,FamilyNameAR:String ,FirstNameEN:String ,FatherNameEN:String ,GrandfatherNameEN:String ,FamilyNameEN:String ,GenderId:String ,DateOfBirth:String ,IsStudent:String ,MaritalStatusId:String ,AccommodationTypeId:String ,Address:String ,EmirateId:String ,POBox:String ,MobileNo:String ,OtherMobileNo:String ,PhoneNo:String ,Email:String ,MakaniNo:String ,XCoord:String ,YCoord:String ,DiagnosisAuthorityId:String ,DiagnosisInformation:String , DisabilityTypeId:String ,DisabilityLevelId:String ,SupportingEquipment:String ,NeedSupporter:String ,CanLiveAlone:String ,ReportIssuedBy:String,Speciality:String ,ReportDate:String , OrganizationId:String ,ResidenceExpiryDate:String,WorkingStatusId:String,WorkFieldId:String,Company:String,InstitutionId:String,CenterId:String  ,SecurityToken:String ,UserId:String,DisabledCardNo: String ,cardIssueDate:String , cardExpiryDate: String ,ServiceDocTypeIds:String ,filesArray: [URL],item: Gallery? ,view: UIView ,completation: @escaping ([String:Any] , NSMutableArray ,_ error: Error?)->Void ){
        ...
        parametersArray?["DisabledCardNo"] = DisabledCardNo
        
        
        parametersArray?["CardIssueDate"] = cardIssueDate
        parametersArray?["CardExpiryDate"] = cardExpiryDate
        ...
        let request = AFHTTPRequestSerializer().multipartFormRequest(withMethod: "POST", urlString: uploadURL, parameters: nil, constructingBodyWith: { (formData) in
            ...
            formData.appendPart(withForm: DisabledCardNo.data(using: String.Encoding.utf8)!, name: "DisabledCardNo")
            
            
            formData.appendPart(withForm: cardIssueDate.data(using: String.Encoding.utf8)!, name: "CardIssueDate")
            formData.appendPart(withForm: cardExpiryDate.data(using: String.Encoding.utf8)!, name: "CardExpiryDate")
    ...
    static func CreateReplaceDisabledCardRequest(disabledCardId:String ,requestTypeId: String ,comments: String ,emailAddress:String ,UserId:String ,ServiceDocTypeIds:String ,filesArray: [URL],item: Gallery? ,view: UIView ,completation: @escaping ([String:Any] , NSMutableArray ,_ error: Error?)->Void ){
          
           
           
        let apiString = "CreateReplaceDisabledCardRequest"
        ...
        parametersArray?["disabledCardId"] = disabledCardId
        
        parametersArray?["requestTypeId"] = requestTypeId
        
        parametersArray?["comments"] = comments
        ...
        let request = AFHTTPRequestSerializer().multipartFormRequest(withMethod: "POST", urlString: uploadURL, parameters: nil, constructingBodyWith: { (formData) in
            ...
            formData.appendPart(withForm: disabledCardId.data(using: String.Encoding.utf8)!, name: "disabledCardId")
            
            formData.appendPart(withForm: requestTypeId.data(using: String.Encoding.utf8)!, name: "requestTypeId")
            
            formData.appendPart(withForm: comments.data(using: String.Encoding.utf8)!, name: "comments")
