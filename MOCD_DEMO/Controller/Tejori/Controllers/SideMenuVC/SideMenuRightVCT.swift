...
class SideMenuRightVCT: UIViewController ,UITableViewDataSource,UITableViewDelegate{
    ...
    override func viewDidLoad() {
        ...
        Utility.sharedInstance.customizeFonts(in: tblSidemenu, aFontName: Medium, aFontSize: 3)
    }
...
//        SideMenuCell.imageView?.transform = CGAffineTransform(scaleX: -1.0, y: 1.0)
