...
let aStrDBNameT = "Edkhar.sqlite"
let aStrDBTitleT = "Edkhar"
let aStrDBExtenstionT = "sqlite"
...
class DatabaseEdkhar: NSObject {
    ...
    func createEditableCopyOfDatabaseIfNeeded(failure complitionFailure: (()-> Void)) {
        ...
        let sourcePath = Bundle.main.path(forResource: aStrDBTitleT, ofType: aStrDBExtenstionT)
        
        let dbPath = DatabaseEdkhar.createPath(dbname: aStrDBNameT)
