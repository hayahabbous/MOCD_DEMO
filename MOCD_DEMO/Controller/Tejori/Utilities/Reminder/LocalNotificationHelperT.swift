...
*/
class LocalNotificationHelperT: NSObject {
    
    // MARK:singleton sharedInstance
    static let sharedInstance = LocalNotificationHelperT()
    ...
    func createReminderNotification(_ reminderId: String,_ title: String,_ task: String,weekDay: Int = 0, monthDay: Int = 0, hour: Int = 0, minute: Int = 0, seconds: Int = 0, notificationDate: Date = Date(),_ repeatMode: NotificationType) {
